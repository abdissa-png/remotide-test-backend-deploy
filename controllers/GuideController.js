...
const createGuide = catchAsync(async (req, res) => {
  ...
  res
    .status(201)
    .json({ status: "success", message: "Guide created successfully", guide });
});
...
const updateGuideById = catchAsync(async (req, res) => {
  ...
  res
    .status(200)
    .json({ status: "success", message: "Guide updated successfully", guide });
});
...
const deleteGuideById = catchAsync(async (req, res) => {
  ...
  res
    .status(200)
    .json({ status: "success", message: "Guide deleted successfully", guide });
});
